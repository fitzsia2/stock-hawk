...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsConnected = Utils.HasConnectivity(this);
                ...
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        Intent intent = new Intent(mContext, DetailsActivity.class)
                                .putExtra(DetailsActivity.STOCK_SYMBOL, stockSym);
        ...
        // Setup the floating button to add new stocks
            ...
            public void onClick(View v) {
                if (mIsConnected) {
                    new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                            ...
                            .inputRangeRes(2, 8, R.color.material_red_500)
                            .input(R.string.input_hint, R.string.empty_input_prefill, new MaterialDialog.InputCallback() {
                                @Override
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        TextView tv = (TextView) this.findViewById(R.id.recycler_view_empty);
        assert tv != null;
